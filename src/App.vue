...
function buildGifRantLines(sizeRatioStr) {
  return [
    ...
    '',
    'Gratulacje. Serwer musi przesłać ponad ${sizeRatioStr} więcej danych, użytkownik pobiera ponad ${sizeRatioStr} danych, a w nagrodę dostaje animację wyglądającą jak relikt z 1998 roku.',
    '',
